...
class pm_sensor:
    ...
    def read_pm(self):
        ...
        originally from https://gist.github.com/marw/9bdd78b430c8ece8662ec403e04c75fe
        '''
    ...
    def sensor_sleep(self):
        ...
        originally from https://github.com/luetzel/sds011/blob/master/sds011_pylab.py
        '''
        if not ser.isOpen():
            ser.open()
